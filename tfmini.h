 ...
 */
int tfmini_distance(void) __fromfile("libtfmini/tfmini.c");
 ...
 * @return temperature
 */
int tfmini_temperature(void) __fromfile("libtfmini/tfmini.c");

/**
 * @brief set measurement units
 * @param units 1-cm, 2-mm
 */
void tfmini_setUnits(int units) __fromfile("libtfmini/tfmini.c");

/**
 * @brief set update rate
 * @param rate 1 - 1000 Hz
 */
void tfmini_setRate(short rate) __fromfile("libtfmini/tfmini.c");
