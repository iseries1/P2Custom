...
s32_t spiffs_obj_lu_scan(
    spiffs *fs) __fromfile("libspiffs/spiffs_nucleus.c");
...
s32_t spiffs_gc_quick(
    spiffs *fs, u16_t max_free_pages) __fromfile("libspiffs/spiffs_gc.c");
...
void spiffs_cache_init(
    spiffs *fs) __fromfile("libspiffs/spiffs_cache.c");
...
s32_t spiffs_lookup_consistency_check(
    spiffs *fs,
    u8_t check_all_objects) __fromfile("libspiffs/spiffs_check.c");
