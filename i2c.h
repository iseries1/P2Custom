 ...
 */
int I2C_Poll(i2c_t *x, int address) __fromfile("libi2c/i2c.c");

/**
 * @brief Start i2c transmission
 * @param x i2c device
 */
void I2C_Start(i2c_t *x) __fromfile("libi2c/i2c.c");

/**
 * @brief Stop i2c transmission
 * @param x i2c device
 */
void I2C_Stop(i2c_t *x) __fromfile("libi2c/i2c.c");
 ...
 */
int I2C_WriteByte(i2c_t *x, int b) __fromfile("libi2c/i2c.c");
 ...
 */
int I2C_ReadByte(i2c_t *x, int ack) __fromfile("libi2c/i2c.c");
 ...
 */
int I2C_WriteData(i2c_t *x, char *data, int count) __fromfile("libi2c/i2c.c");
 ...
 */
int I2C_ReadData(i2c_t *x, char *data, int count) __fromfile("libi2c/i2c.c");
 ...
 * @return amount read
 */
int I2C_In(i2c_t *x, int address, int reg, int size, char *data, int count) __fromfile("libi2c/i2c.c");
 ...
 */
int I2C_Out(i2c_t *x, int address, int reg, int size, char *data, int count) __fromfile("libi2c/i2c.c");
